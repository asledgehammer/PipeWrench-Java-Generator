...
public final class ScriptParser {
  ...
  public static String stripComments(String var0) {
    ...
    int var2;
    for (int var1 = stringBuilder.lastIndexOf("*/");
        var1 != -1;
      ...
      int var4;
      for (int var3 = stringBuilder.lastIndexOf("*/", var1 - 1);
          var3 > var2;
  ...
  public static class Block implements ScriptParser.BlockElement {
    ...
    @Override
    public void prettyPrint(int index, StringBuilder builder, String var3) {
      builder.append("\t".repeat(Math.max(0, index)));
      ...
      builder.append('{');
      builder.append(var3);
      prettyPrintElements(index + 1, builder, var3);
      builder.append("\t".repeat(Math.max(0, index)));
      builder.append('}');
      builder.append(var3);
    }

    public void prettyPrintElements(int var1, StringBuilder builder, String var3) {
      ScriptParser.BlockElement element = null;

      for (ScriptParser.BlockElement nextElement : this.elements) {
        if (nextElement.asBlock() != null && element != null) {
          builder.append(var3);
        }

        if (nextElement.asValue() != null && element instanceof ScriptParser.Block) {
          builder.append(var3);
        }

        nextElement.prettyPrint(var1, builder, var3);
        element = nextElement;
      }
    }
    ...
    public ScriptParser.Block getBlock(String var1, String var2) {
      for (ScriptParser.Block var4 : this.children) {
        if (var4.type.equals(var1)
            && (var4.id != null && var4.id.equals(var2) || var4.id == null && var2 == null)) {
          return var4;
        }
      }
    ...
    public ScriptParser.Value getValue(String var1) {
      for (ScriptParser.Value var3 : this.values) {
  ...
  public static class Value implements ScriptParser.BlockElement {
    ...
    public void prettyPrint(int var1, StringBuilder var2, String var3) {
      var2.append("\t".repeat(Math.max(0, var1)));
